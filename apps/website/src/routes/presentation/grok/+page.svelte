			...
			>
				...
				<div class="section-content">
					...
					{#if ['dao', 'implementation', 'your-role', 'lifestyle'].includes(section.id)}
						<div class="process-visual" in:fade={{ duration: 600, delay: 300 }}>
							<div class="process-timeline">
								<div class="timeline-track"></div>
								<div
									class="timeline-progress"
									style="width: {['dao', 'implementation', 'your-role', 'lifestyle'].indexOf(
										section.id
									) *
										33 +
										33}%"
								...
								<div class="timeline-steps">
									<div
										class="step"
										class:active={processStates[section.id] === 'idea' ||
											['implementation', 'your-role', 'lifestyle'].includes(section.id)}
									>
										<div class="step-icon">
											<svg
												xmlns="http://www.w3.org/2000/svg"
									...
									<div
										class="step"
										class:active={processStates[section.id] === 'vote' ||
											['your-role', 'lifestyle'].includes(section.id)}
									>
										<div class="step-icon">
											<svg
												xmlns="http://www.w3.org/2000/svg"
									...
									<div
										class="step"
										class:active={processStates[section.id] === 'draft' ||
									...
									<div class="vote-progress">
										<div class="vote-bar">
											<div
												class="vote-fill"
												style="width: 75%"
												in:slide={{ duration: 1000, delay: 800, easing: quintOut }}
											></div>
										</div>
							...
							{#if section.id === 'lifestyle'}
								<div class="reward-visual" in:fade={{ duration: 600, delay: 600 }}>
									<div class="reward-tokens">
										<div class="token euro" in:scale={{ duration: 600, delay: 700, start: 0.5 }}>
											€
										</div>
										<div class="token vcr" in:scale={{ duration: 600, delay: 900, start: 0.5 }}>
											VCR
										</div>
									</div>
						...
						<div class="subslides-container">
							...
							<div class="subslide-nav">
								{#if currentSubslideIndices[section.id] > 0}
									<button
										class="subslide-nav-button prev"
										on:click={() => prevSubslide(section.id)}
										aria-label="Go to previous subslide"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="24"
								...
								{#if currentSubslideIndices[section.id] < section.subslides.length - 1}
									<button
										class="subslide-nav-button next"
										on:click={() => nextSubslide(section.id)}
										aria-label="Go to next subslide"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="24"
					...
					{#if !section.hasSubslides && section.hasListItems && section.listItems && section.listItems.length > 0}
						...
						{:else if section.id === 'hominio'}
							<ul class="hominio-features">
								{#each section.listItems as item, itemIndex}
									<li in:fly={{ y: 20, duration: 800, delay: 2400 + itemIndex * 100 }}>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="16"
											height="16"
						...
						{:else}
							<ul class="content-list">
								{#each section.listItems as item, itemIndex}
									<li in:fly={{ y: 20, duration: 800, delay: 300 + itemIndex * 100 }}>{item}</li>
								{/each}
							</ul>
						{/if}
					{/if}
					...
					{#if section.callToAction}
						<p class="call-to-action" in:fly={{ y: 20, duration: 800, delay: 500 }}>
