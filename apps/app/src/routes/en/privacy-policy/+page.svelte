<TextWrap>
	...
	<p>
		...
		with your personal data when you visit this website. The term &ldquo;personal data&rdquo;
	...
	<p>
		...
		is available under section &ldquo;Information about the responsible party (referred to as the
	...
	<p>
		...
		metadata and communications, contract information, contact information, names, web page access,
	...
	<p>
		...
		(1)(a) GDPR and &sect; 25 (1) TDDDG, insofar the consent includes the storage of cookies or the
	...
	<p>
		...
		fingerprinting), the data processing is additionally based on &sect; 25 (1) TDDDG. The consent
		...
		we process it on the basis of Art. 6(1)(c) GDPR. Furthermore, the data processing may be carried
	...
	<p>
		...
		contract, if we are legally obligated to do so (e.g., disclosure of data to tax authorities), if
		we have a legitimate interest in the disclosure pursuant to Art. 6 (1)(f) GDPR, or if another
		legal basis permits the disclosure of this data. When using processors, we only disclose
		personal data of our customers on the basis of a valid contract on data processing. In the case
	...
	<p>
		...
		format. If you should demand the direct transfer of the data to another controller, this will be
	...
	<p>
		...
		purpose of the processing of your data at any time. You may also have a right to have your data
	...
	<p>
		...
		exception of their archiving &ndash; may be processed only subject to your consent or to claim,
		exercise or defend legal entitlements or to protect the rights of other natural persons or legal
		entities or for important public interest reasons cited by the European Union or a member state
		of the EU.
	</p>
	...
	<p>
		...
		address line of the browser switches from &ldquo;http://&rdquo; to &ldquo;https://&rdquo; and
	...
	<p>
		...
		information to be provided in our Site Notice to send us promotional and information material
		that we have not expressly requested. The operators of this website and its pages reserve the
		express right to take legal action in the event of the unsolicited sending of promotional
	...
	<p>
		...
		temporarily for the duration of a session (session cookies) or they are permanently archived on
		your device (permanent cookies). Session cookies are automatically deleted once you terminate
		your visit. Permanent cookies remain archived on your device until you actively delete them, or
	...
	<p>
		Cookies, which are required for the performance of electronic communication transactions, for
		...
		optimized provision of the operator&rsquo;s services. If your consent to the storage of the
		cookies and similar recognition technologies has been requested, the processing occurs
		exclusively on the basis of the consent obtained (Art. 6(1)(a) GDPR and &sect; 25 (1) TDDDG);
	...
	<p>
		...
		you have registered for. The required information we request at the time of registration must be
