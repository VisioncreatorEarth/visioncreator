...
import { printAgent } from '$lib/agents/printAgent';
...
const coordinatorTools = [
	...
	{
		name: 'printAgent',
		description: 'Use this agent for tasks related to printing or logging information.',
		input_schema: {
			type: 'object',
			properties: {
				message: { type: 'string', description: 'The message to be printed or logged' }
			},
			required: ['message']
		}
	},
