<script lang="ts">
	...
	let paragraphs = [
		...
		'It drives me to create and change the world.',
		'My heart sings with purpose.',
		'It beats in time with our shared vision.',
		"I'm overwhelmed.",
		"Words can't capture how I feel.",
		'Seven years ago, I took a chance.',
		'I became a Visioncreator.',
		'That choice changed everything.',
		'Not just for me, but for many others too.',
		...
		'Each day, every Visioncreator invest 1€ in our shared future.',
		"It's a small seed that grows big.",
		'This simple act unlocks our true potential of humanity. One person at a time.',
		'We discover, build and own world-changing startups, every other day',
