...
export default createOperation.mutation({
  ...
  handler: async ({ input, context, operations }) => {
    try {
      console.log(
        "Step 1: Received input object:",
        JSON.stringify(input.object, null, 2)
      );
      ...
      console.log(
        "Step 2: Validated $schema property exists:",
        input.object.$schema
      );
      ...
      console.log(
        "Step 4: Schema fetched successfully:",
        JSON.stringify(schemaData.json, null, 2)
      );
      ...
      console.log(
        "Step 6: CID calculated successfully:",
        calcCIDResult.data.json.$id
      );
      ...
      console.log(
        "Step 7: Created object with ID:",
        JSON.stringify(objectWithId, null, 2)
      );
      ...
      console.log(
        "Step 11: Object inserted successfully:",
