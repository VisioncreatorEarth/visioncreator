...
INSERT INTO proposals (title, author, details, benefits, pain, state, tags) VALUES
    ...
    'Launch your own AI voice agent business in one week. Earn 60% revenue share per customer with zero technical skills needed.',
    'Creators lack easy ways to build recurring revenue streams and need technical expertise to create AI solutions.',
    'idea',
    ARRAY['startup']);
